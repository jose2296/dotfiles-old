...
function homestead() {
    ...
    ssh)
        ...
        (cd ~/workspace/homestead && vagrant ssh -- -t "cd \"$relPath\" 2>/dev/null; exec \$SHELL --login")
        ;;
    edit)
        open ~/workspace/homestead/Homestead.yaml
        ;;
    *)
...
alias start-api='sudo service apache2 stop && vessel start'
